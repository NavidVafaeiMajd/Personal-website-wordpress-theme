...
<main>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <h2>   توضیحات خلاصه صفحه اصلی </h2>
        <textarea id="descriptionOfHome" name="descriptionOfHome" style="    width: 520px !important; min-height: 200px;"><?php echo get_option( "descriptionOfHome" , "" )?></textarea>
